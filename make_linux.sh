...
COMPILE="g++ -DOS_LINUX -DLEVELDB_PLATFORM_POSIX -DNDEBUG -DENABLE_JNI -I. -Iinclude -I${JAVA_HOME}/include -I${JAVA_HOME}/include/linux -O3 -ffast-math -fweb -fomit-frame-pointer -fmerge-all-constants -fno-builtin-memcmp -fPIC -pipe -pthread -s"
